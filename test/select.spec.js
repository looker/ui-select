...
describe('ui-select tests', function () {
  ...
  function createUiSelect(attrs) {
    ...
    if (attrs !== undefined) {
      ...
      if (attrs.taggingTokenEscape !== undefined) {
        attrsHtml += ' tagging-token-escape="' + attrs.taggingTokenEscape + '"';
      }
      if (attrs.tagOnBlur !== undefined) {
        attrsHtml += ' tag-on-blur="' + attrs.tagOnBlur + '"';
      }
  ...
  describe('multi selection', function () {
    ...
    function createUiSelectMultiple(attrs) {
      ...
      if (attrs !== undefined) {
        ...
        if (attrs.paste !== undefined) {
          attrsHtml += ' paste="' + attrs.paste + '"';
        }
        if (attrs.inputId !== undefined) {
          attrsHtml += ' input-id="' + attrs.inputId + '"';
        }
